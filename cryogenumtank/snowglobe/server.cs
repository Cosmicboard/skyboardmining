...
datablock PlayerData(SnowglobePlayer : PlayerStandardArmor) {
	shapeFile = "./Snowglobemounted.dts";
...
datablock ItemData(SnowglobeItem)
{
	category = "Weapon";  // Mission editor category
	className = "Weapon"; // For inventory system

	 // Basic Item Properties
	shapeFile = "./Snowglobe.dts";
	mass = 1;
	density = 0.2;
	elasticity = 0.2;
	friction = 0.6;
	...
	image = SnowglobeImage;
	canDrop = true;
};

datablock ShapeBaseImageData(SnowglobeImage)
{
   // Basic Item properties
   shapeFile = "./Snowglobe.dts";
   emap = true;
   ...
   //casing = " ";
   doColorShift = true;
   colorShiftColor = SnowglobeItem.colorShiftColor;
...
function SnowglobeImage::onEquip(%this,%obj,%slot)
{
